    ...
    <div class="wrapper">
        <div class="works">
            ...
            <div class="works__content">
                ...
                <div class="works__content__link">
                    <router-link to="/fysi-detail" class="works__content__link__btn" target="_blank">詳細へ</router-link>
        ...
        <div class="works">
            ...
            <div class="works__content">
                ...
                <div class="works__content__link">
                    <router-link to="/fitness-detail" class="works__content__link__btn" target="_blank">詳細へ</router-link>
        ...
        <div class="works">
            ...
            <div class="works__content">
                ...
                <div class="works__content__link">
                    <router-link to="/lookclothe-detail" class="works__content__link__btn" target="_blank">詳細へ</router-link>
        ...
        <div class="works">
            ...
            <div class="works__content">
                ...
                <div class="works__content__link">
                    <router-link to="/mama-detail" class="works__content__link__btn" target="_blank">詳細へ</router-link>
...
.works__content__date, .works__content__ttl, .works__content__catch-copy, .works__content__link__btn{
    font-family: $jpFont;
}
</style>